    ...
    async def on_register_message(self, message):
        try:
            ...
            if (self.spread_content.id_exists(str(message.author))):
                register_name = self.spread_content.convert_id_to_name(str(message.author))
                print(register_name)
...
class messageManager(commands.Cog):
    ...
    def register_name(self, registrant_name):
        try:
            send_message = self.spread_content.registered_name(registrant_name, "", is_meow=self.is_meow)
